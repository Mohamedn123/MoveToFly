<?php
    ...
    $NonApprovedCount = $ReviewsController->getNonApprovedCount();
    $ApprovedCount = $ReviewsController->getApprovedCount();
    $ContactController = new ContactController();
    $ContactCount = $ContactController->getCount();
    $TripsController = new TripsController();
    $TripsCount = $TripsController->getCount();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="title">Approved Reviews</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box brown-bg">
              ...
              <div class="count"><?php echo $NonApprovedCount; ?></div>
              <div class="title">Reviews Waiting Approval</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              <i class="fa fa-clock-o"></i>
              <div class="count"><?php echo $ContactCount ?></div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box green-bg">
              ...
              <div class="count"><?php echo $TripsCount ?></div>
