              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_house_alt"></i> Title</th>
                    <th><i class="icon_house_alt"></i> Body</th>
                    ...
                    if($Contacts != null){
                       for ($x=0;$x<sizeof($Contacts);$x++){
                            echo '<tr>
                                ...
                                <td>'.$Contacts[$x]->getTitle().'</td>
                                <td>'.$Contacts[$x]->getBody().'</td>
                                <td>
                                  <div class="btn-group">
                                    <a class="btn btn-danger" href="../Controller/ContactController.php?Delete='.$Contacts[$x]->getID().'"><i class="icon_close_alt2"></i></a>
                                  </div>
                                </td>
                              </tr>';
                       }
                        ...
                        echo "<p><i>You are all caught up no pending Contacts Requests</i></p>";
                    }
                  ?>
                </tbody>
              </table>
