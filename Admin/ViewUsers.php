              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_house_alt"></i> User Role</th>
                  ...
                  <?php
                    if($Users != null){
                       for ($x=0;$x<sizeof($Users);$x++){
                            echo '<tr>
                                <td>'.$Users[$x]->getName().'</td>
                                <td>'.$Users[$x]->getUsername().'</td>
                                <td>'.$Users[$x]->getEmail().'</td>
                                <td>'.$Users[$x]->getUsertype().'</td>
                                <td>
                                  <div class="btn-group">
                                    <a class="btn btn-danger" href="../Controller/UserController.php?Delete='.$Users[$x]->getID().'"><i class="icon_close_alt2"></i></a>
                                  </div>
                                </td>
                              </tr>';
                       }
