...
require_once __DIR__.'/../Controller/TripContactController.php';
...
$TripContactController = new TripContactController();
$Contacts = $TripContactController->GetAll();
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_house_alt"></i> Trip</th>
                    <th><i class="icon_cogs"></i> Action</th>
                  </tr>
                  <?php
                    if($Contacts != null){
                       for ($x=0;$x<sizeof($Contacts);$x++){
                            $Trip = $TripsController->SelectByID($Contacts[$x]->getTripID());
                            if ($Trip != null){
                                echo '<tr>
                                <td>'.$Contacts[$x]->getName().'</td>
                                <td><a href = "mailto:'.$Contacts[$x]->getEmail().'">'.$Contacts[$x]->getEmail().'</td>
                                <td>'.$Contacts[$x]->getPhone().'</td>
                                <td>'.$Trip->getName().'</td>
                                <td>
                                  <div class="btn-group">
                                    <a class="btn btn-danger" href="../Controller/TripContactController.php?Delete='.$Contacts[$x]->getID().'"><i class="icon_close_alt2"></i></a>
                                  </div>
                                </td>
                              </tr>';
                            }
                        ...
                        echo "<p><i>You are all caught up no pending Requests</i></p>";
                    }
                  ?>
                </tbody>
              </table>
