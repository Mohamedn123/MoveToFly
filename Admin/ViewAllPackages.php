              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_profile"></i> Start Date</th>
                    <th><i class="icon_mail_alt"></i> End Date</th>
                    <th><i class="icon_house_alt"></i> Price</th>
                  ...
                  <?php
                    if($Trips != null){
                       for ($x=0;$x<sizeof($Trips);$x++){
                            echo '<tr>
                                <td>'.$Trips[$x]->getName().'</td>
                                <td>'.$Trips[$x]->getStartDate().'</td>
                                <td>'.$Trips[$x]->getEndDate().'</td>
                                <td>'.$Trips[$x]->getPrice().'</td>
                                <td>
                                  <div class="btn-group">
                                    <a class="btn btn-primary" href="EditPackage.php?ID='.$Trips[$x]->getID().'"><i class="icon_pencil"></i></a>
                                    <a class="btn btn-danger" href="../Controller/TripsController.php?Delete='.$Trips[$x]->getID().'"><i class="icon_close_alt2"></i></a>
                                  </div>
                                </td>
                              </tr>';
                       }
