...
require_once __DIR__.'/../Model/PlacesModel.php';
                  ...
                  <?php
                    if($Places != null){
                       for ($x=0;$x<sizeof($Places);$x++){
                            echo '<tr>
                                <td>'.$Places[$x]->getID().'</td>
                                <td>'.$Places[$x]->getName().'</td>
                                <td>
                                  <div class="btn-group">
                                    <a class="btn btn-danger" href="../Controller/PlacesController.php?Delete='.$Places[$x]->getID().'"><i class="icon_close_alt2"></i></a>
                                  </div>
                                </td>
                              </tr>';
                       }
                        ...
                        echo "<p><i>No Places Found Please add Some</i></p>";
                    }
                  ?>
                </tbody>
              </table>
