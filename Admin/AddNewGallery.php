    ...
    <section id="main-content">
        <div class="container">
          ...
          <div class="panel-body">
              <form class="form-horizontal " method="post" action="../Controller/GalleryController.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <button type="submit" name="insert" class="btn btn-primary">Create Gallery</button>
                </form>
          </div>
