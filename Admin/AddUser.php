...
if (isset($_GET['error'])){
    echo"<script> alert('Same email or username exists please choose different one'); </script>";
}
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="panel-body">
              <form class="form-horizontal " method="post" action="../Controller/UserController.php">
                  ...
                  <div class="form-group">
                    ...
                    <button type="submit" name="insert" class="btn btn-primary">Create User</button>
                </form>
          </div>
