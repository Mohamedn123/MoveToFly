                  ...
                  <?php
                    if($Galleries != null){
                       for ($x=0;$x<sizeof($Galleries);$x++){
                            echo '<tr>
                                <td>'.$Galleries[$x]->getTitle().'</td>
                                <td>
                                  <div class="btn-group">
                                    <a class="btn btn-danger" href="../Controller/GalleryController.php?Delete='.$Galleries[$x]->getID().'"><i class="icon_close_alt2"></i></a>
                                  </div>
                                </td>
                              </tr>';
                       }
                        ...
                        echo "<p><i>No Gallery Found Please add Some</i></p>";
                    }
                  ?>
                </tbody>
              </table>
